...
import { BookOpen, Target, Scroll, EyeOff } from 'lucide-react'
            ...
            <div className='grid gap-6'>
              {courses.slice(0, 2).map((course) =>
                course.isVisible ? (
                  ...
                  <div key={course.id}>
                    <Card className='border-0 overflow-hidden bg-white/80 backdrop-blur-sm shadow-md relative opacity-60'>
