...
export default function LessonDetailPage(props: {
  ...
  if (!lesson || !course) {
    return (
      <div className='flex flex-col items-center justify-center min-h-screen'>
        ...
        <Link href={`/expert/course/${params.id}/chapter/${params.chapterId}`}>
  ...
  if (!chapter) {
    return (
      <div className='flex flex-col items-center justify-center min-h-screen'>
        ...
        <Link href={`/expert/course/${params.id}`}>
  ...
  const breadcrumbItems = [
    ...
    {
      title: course.title,
      href: `/expert/course/${params.id}`
    },
    {
      title: chapter.title,
      href: `/expert/course/${params.id}/chapter/${chapter.id}`
    },
    {
      title: lesson.title
    }
