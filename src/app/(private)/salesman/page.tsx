...
import { StatsCard } from '@/components/private/salesman/dashboard/stats-card'
import { RevenueChart } from '@/components/private/salesman/dashboard/revenue-chart'
import { OrderStatusChart } from '@/components/private/salesman/dashboard/order-status-chart'
import { DistributionChart } from '@/components/private/salesman/dashboard/distribution-chart'
import {
  BestSellingPhysicalProducts,
  BestSellingCourses
} from '@/components/private/salesman/dashboard/best-selling-products'
import { DataNote } from '@/components/private/salesman/dashboard/data-note'
import { DashboardSkeleton } from '@/components/private/salesman/dashboard/dashboard-skeleton'
      ...
      <div className='grid gap-6 md:grid-cols-2'>
        ...
        <div>
          <BestSellingPhysicalProducts
            ...
            onItemClick={(product) => {
              if (product?.id) {
                router.push(`${configRoute.salesman.product}/${product.id}`)
              }
            }}
          />
        </div>
        ...
        <div>
          <BestSellingCourses
            ...
            onItemClick={(course) => {
              if (course?.id) {
                router.push(`${configRoute.salesman.course}/${course.id}`)
              }
            }}
          />
        </div>
