...
import { handleErrorApi, formatOrderStatus } from '@/lib/utils'
...
function AdminOrder(props: { searchParams: SearchParams }) {
  ...
  // Cấu hình màu sắc cho trạng thái (chỉ giữ lại thông tin về variant)
  ...
  const bodyColumn = useMemo(
    ...
    [orderStatusVariants, paymentMethodConfig, router, handleConfirmDelivery]
  )
        ...
        filterComponent={
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value='EXCHANGING'>Đang xử lý đổi hàng</SelectItem>
