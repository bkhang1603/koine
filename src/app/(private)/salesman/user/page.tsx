...
function UsersPage(props: { searchParams: SearchParams }) {
  ...
  const bodyColumn = useMemo(
    () => [
      ...
      },
      {
        id: 6,
        render: (user: any) => (
          <MoreOptions itemType='user' onView={() => router.push(`/salesman/user/${user.id}`)} item={user} />
        )
      }
    ],
    [router]
  ...
  return (
    <div className='container mx-auto px-4 py-6 space-y-6'>
      ...
      <TableCustom
        ...
        href={configRoute.salesman.user}
        loading={isLoading}
        showSearch={true}
