...
export default function LessonDetailPage(props: {
  ...
  if (!lesson || !course) {
    return (
      <div className='flex flex-col items-center justify-center min-h-screen'>
        ...
        <Link href={`/admin/course/${params.id}/chapter/${params.chapterId}`}>
  ...
  if (!chapter) {
    return (
      <div className='flex flex-col items-center justify-center min-h-screen'>
        ...
        <Link href={`/admin/course/${params.id}`}>
  ...
  const breadcrumbItems = [
    ...
    {
      title: course.title,
      href: `/admin/course/${params.id}`
    },
    {
      title: chapter.title,
      href: `/admin/course/${params.id}/chapter/${chapter.id}`
    },
    {
      title: lesson.title
    }
      ...
      <div className='container mx-auto px-4 py-6'>
        ...
        <div className='flex items-center justify-between mb-6'>
          <Button variant='outline' asChild>
            <Link href={`/admin/course/${params.id}/chapter/${chapter.id}`}>
