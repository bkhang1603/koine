...
export default function ReportDetailPage(props: { params: Promise<{ id: string }> }) {
    ...
    return (
      <div className='flex flex-col items-center justify-center min-h-[400px] gap-4'>
        ...
        <Button variant='outline' asChild>
          <Link href='/admin/report'>Quay lại danh sách báo cáo</Link>
        </Button>
      </div>
    )
  }
  ...
  const getEntityUrl = () => {
    ...
    switch (reportData.type) {
      case 'COURSE':
        return `/admin/course/${reportData.reportedEntityId}`
      case 'BLOG':
        return `/admin/blog/${reportData.reportedEntityId}`
      default:
        return null
    }
  }
        ...
        <CardContent className='space-y-6'>
          ...
          <div className='flex justify-end gap-4'>
            {canResolve ? (
              ...
              <Button variant='outline' asChild>
                <Link href='/admin/report'>Quay lại danh sách</Link>
              </Button>
            )}
          </div>
        </CardContent>
