  ...
  const bodyColumn = useMemo(
    () => [
      ...
      },
      {
        id: 5,
        render: (report: any) => {
          // Xác định label cho nút Xem chi tiết dựa trên trạng thái
          let viewLabel = 'Xem chi tiết'
          if (report.status === 'PENDING') {
            viewLabel = 'Xử lý báo cáo'
          }
          ...
          return (
            <MoreOptions
              ...
              itemType='ticket'
              onView={() => router.push(`${configRoute.support.report}/${report.id}`)}
